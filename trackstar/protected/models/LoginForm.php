...
// 			User::model()->updateByPk($this->_identity->id,array('last_login_time'=>date('Y-m-d H:i:s')));
			User::model()->updateByPk($this->_identity->id,array('last_login_time'=>new CDbExpression('NOW()')));
// 			User::model()->updateByPk($this->_identity->id,array('last_login_time'=>date('Y-m-d H:i:s',Yii::app()->user->lastLoginTime)));
			return true;
		}
		else
			return false;
