...
// 				$this->redirect(array('view','id'=>$model->id));
	...
	public function actionUpdatePass($id)
	{
		...
		$model->unsetAttributes(array('password_old','password','password_repeat'));//清除所有的值
		...
		{
			$model->attributes=$_POST['User'];
			if ($tmpOldPassword != User::model()->encrypt($model->password_old)){
				$model->addError('password_old', 'Old Password is not Right!!');
